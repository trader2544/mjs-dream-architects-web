...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      description: "Modern apartment buildings with premium finishes across Kenya"
    },
    {
      id: 2,
      ...
      category: "residential",
      description: "Custom residential homes with elegant Kenyan architecture"
    },
    {
      id: 3,
      ...
      category: "residential",
      description: "Sophisticated two-story homes with contemporary Kenyan design"
    },
    {
      id: 4,
      ...
      category: "residential",
      description: "Luxury residential complexes with world-class amenities"
    },
    {
      id: 5,
      ...
      category: "residential",
      description: "Beautiful red-tiled homes perfect for Kenya's climate"
    },
    {
      id: 6,
      ...
      category: "commercial",
      description: "Large-scale commercial and mixed-use projects"
    },
    {
      id: 7,
      ...
      category: "commercial",
      description: "Contemporary high-rise buildings and towers"
    },
    {
      id: 8,
      ...
      category: "residential",
      description: "Stylish residential developments with modern amenities"
    },
    {
      id: 9,
  ...
  return (
    <section id="portfolio" className="py-8 md:py-12 lg:py-24 bg-slate-50">
      <div className="container mx-auto px-4">
        <AnimatedCard animation="fade-up" className="text-center mb-8 md:mb-12 lg:mb-16">
          <h2 className="text-xl md:text-2xl lg:text-4xl xl:text-5xl font-bold text-slate-900 mb-3 md:mb-4 lg:mb-6">
            Our Projects Portfolio
          </h2>
          <div className="w-12 md:w-16 lg:w-24 h-1 bg-slate-600 mx-auto mb-4 md:mb-6 lg:mb-8 animate-pulse"></div>
          <p className="text-xs md:text-sm lg:text-lg xl:text-xl text-slate-600 max-w-3xl mx-auto">
          ...
          {filters.map((filter, index) => (
            <Button
              ...
              className={`px-6 py-2 flex items-center space-x-2 hover-scale transition-all duration-300 ${
                activeFilter === filter.key 
                  ? "bg-slate-600 hover:bg-slate-700 scale-105 text-white" 
            ...
            <CarouselContent>
              {filteredProjects.map((project, index) => (
                <CarouselItem key={project.id} className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-white rounded-lg md:rounded-xl lg:rounded-2xl shadow-lg overflow-hidden hover-scale group transition-all duration-500 hover:shadow-2xl hover:shadow-slate-200/50">
                    ...
                    <div className="p-2 md:p-3 lg:p-6">
                      <h3 className="text-xs md:text-sm lg:text-xl font-bold text-slate-900 mb-1 md:mb-2 group-hover:text-slate-600 transition-colors">
                        {project.title}
                      </h3>
                      <p className="text-slate-600 mb-2 md:mb-4 text-xs md:text-xs lg:text-base">
                        {project.description}
                      </p>
                      <Button 
                        variant="outline" 
                        size="sm"
                        className="border-slate-500 text-slate-700 hover:bg-slate-600 hover:text-white text-xs md:text-sm h-6 md:h-8 hover-scale transition-all duration-300"
                      >
                        View Details
                      </Button>
                    </div>
