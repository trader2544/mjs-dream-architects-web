          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <div className="space-y-3 md:space-y-4 bg-slate-50">
                  <div className="flex items-center space-x-3 md:space-x-4">
                    <div className="w-10 md:w-12 h-10 md:h-12 rounded-full flex items-center justify-center bg-zinc-600">
                  ...
                  <div className="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/qr/W7Y5C2TH34Q2B1" className="text-blue-500 hover:text-blue-600 transition-colors text-xs md:text-base">
